Go through Agno framework using Context7 MCP or Web search tool - the documentation is given here https://docs.agno.com/llms.txt and https://docs.agno.com/llms-full.txt
