...
class FileObjectBase(BaseModel):
    ...
    category: FileCategory = Field(default=FileCategory.OTHER, description="High-level file category")
    ...
    is_password_protected: bool = Field(default=False, description="Whether file is password protected")
...
class FileObject(FileObjectBase):
    ...
    scanned_at: datetime = Field(default_factory=datetime.now, description="When file was scanned")
    summarized_at: Optional[datetime] = Field(default=None, description="When AI summary was generated")
